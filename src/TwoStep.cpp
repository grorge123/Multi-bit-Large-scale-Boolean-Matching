...
//        cout << match.first << " ( " << cir1InputBus[match.first].size() << " ) " << match.second << " ( " << cir2InputBus[match.second].size() << " ) " << endl;
#ifdef DBG
...
#endif
        int minNum = min(cir1BusCapacity[match.second], cir2BusCapacity[match.first]);
